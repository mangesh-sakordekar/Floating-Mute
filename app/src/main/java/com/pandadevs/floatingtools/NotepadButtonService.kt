...
class NotepadButtonService : Service() {
    ...
    override fun onCreate() {
        ...
        floatingView = LayoutInflater.from(this).inflate(R.layout.floating_notepad_button, null)
        ...
        val button = floatingView!!.findViewById<ImageButton>(R.id.notepadButton)
        button.alpha = 0.3f
    ...
    private fun toggle() {
        if(isOn){
            ...
            startService(Intent(this, FloatingNotesService::class.java))
        }
        isOn = !isOn
    }
    ...
    override fun onDestroy() {
        ...
        intent.putExtra("message", "Notepad Button")
