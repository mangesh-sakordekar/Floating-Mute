...
class CalculatorButtonService : Service() {
    ...
    override fun onCreate() {
        ...
        floatingView = LayoutInflater.from(this).inflate(R.layout.floating_calculator_button, null)
        ...
        val button = floatingView!!.findViewById<ImageButton>(R.id.calculatorButton)
        button.alpha = 0.3f
    ...
    private fun toggle() {
        if(isOn){
            stopService(Intent(this, CalculatorFloatingService::class.java))
        }
        else{
            startService(Intent(this, CalculatorFloatingService::class.java))
        }
        isOn = !isOn
    }
